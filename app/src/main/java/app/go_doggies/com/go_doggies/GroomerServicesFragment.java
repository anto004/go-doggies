...
//        mGroomerServicesAdapter = new EditTextAdapter(getActivity(), new ArrayList<ServiceItem>());
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        //Cursor to point to current Edit Text
        //Set notifyDataSetChanged to false, set itemDataChanged in Adapter to true
    ...
    static class UpdatePriceToServer extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                Log.d(LOG_TAG, "URL is: "+ url + " Parameter: "+ urlParameter.toString());
